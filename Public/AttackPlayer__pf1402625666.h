...
#include "AttackPlayer__pf1402625666.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/NPC/AttackPlayer.AttackPlayer_C", OverrideNativeName="AttackPlayer_C"))
class UAttackPlayer_C__pf1402625666 : public UBTTask_BlueprintBase
{
public:
	GENERATED_BODY()
	...
	UAttackPlayer_C__pf1402625666(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_AttackPlayer__pf_0(int32 bpp__EntryPoint__pf);
