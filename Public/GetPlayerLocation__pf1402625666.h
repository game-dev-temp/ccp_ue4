...
class AAIController;
class APawn;
#include "GetPlayerLocation__pf1402625666.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/NPC/GetPlayerLocation.GetPlayerLocation_C", OverrideNativeName="GetPlayerLocation_C"))
class UGetPlayerLocation_C__pf1402625666 : public UBTTask_BlueprintBase
{
public:
	GENERATED_BODY()
	...
	UGetPlayerLocation_C__pf1402625666(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
