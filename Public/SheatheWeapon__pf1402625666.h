...
#include "SheatheWeapon__pf1402625666.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/NPC/SheatheWeapon.SheatheWeapon_C", OverrideNativeName="SheatheWeapon_C"))
class USheatheWeapon_C__pf1402625666 : public UBTTask_BlueprintBase
{
public:
	GENERATED_BODY()
	...
	USheatheWeapon_C__pf1402625666(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_SheatheWeapon__pf_0(int32 bpp__EntryPoint__pf);
