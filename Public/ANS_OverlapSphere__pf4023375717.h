...
#include "ANS_OverlapSphere__pf4023375717.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/BP/AI/Enemy/ANS_OverlapSphere.ANS_OverlapSphere_C", OverrideNativeName="ANS_OverlapSphere_C"))
class UANS_OverlapSphere_C__pf4023375717 : public UAnimNotifyState
{
public:
	GENERATED_BODY()
	UANS_OverlapSphere_C__pf4023375717(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
