...
#include "BP_SkySphere_Stylized__pf1273236024.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/BP/Terrain/BP_SkySphere_Stylized.BP_SkySphere_Stylized_C", OverrideNativeName="BP_SkySphere_Stylized_C"))
class ABP_SkySphere_Stylized_C__pf1273236024 : public AActor
{
public:
	GENERATED_BODY()
	...
	ABP_SkySphere_Stylized_C__pf1273236024(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
