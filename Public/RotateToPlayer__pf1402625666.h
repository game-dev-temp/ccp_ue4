...
class AAIController;
class APawn;
#include "RotateToPlayer__pf1402625666.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/NPC/RotateToPlayer.RotateToPlayer_C", OverrideNativeName="RotateToPlayer_C"))
class URotateToPlayer_C__pf1402625666 : public UBTTask_BlueprintBase
{
public:
	GENERATED_BODY()
	...
	URotateToPlayer_C__pf1402625666(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_RotateToPlayer__pf_0(int32 bpp__EntryPoint__pf);
