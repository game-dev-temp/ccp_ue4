...
class UUI_Mei_BuildingMenu_C__pf4215541020;
class UImage;
class UProgressBar;
class UTextBlock;
class UVerticalBox;
...
#include "UI_Mei_HUD__pf4215541020.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/UI/BuildingSystem/UI_Mei_HUD.UI_Mei_HUD_C", OverrideNativeName="UI_Mei_HUD_C"))
class UUI_Mei_HUD_C__pf4215541020 : public UUserWidget, public IBPI_Mei_BuildingWidget_C, public IBPI_Mei_InteractionWidget_C
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="BuildingMenu", Category="UI_Mei_HUD", OverrideNativeName="BuildingMenu"))
	UUI_Mei_BuildingMenu_C__pf4215541020* bpv__BuildingMenu__pf;
	UPROPERTY(Export, meta=(DisplayName="CrosshairImage", OverrideNativeName="CrosshairImage"))
	UImage* bpv__CrosshairImage__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="DurabilityProgressBar", Category="UI_Mei_HUD", OverrideNativeName="DurabilityProgressBar"))
	UProgressBar* bpv__DurabilityProgressBar__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="DurabilityText", Category="UI_Mei_HUD", OverrideNativeName="DurabilityText"))
	UTextBlock* bpv__DurabilityText__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="ErrorMessageText", Category="UI_Mei_HUD", OverrideNativeName="ErrorMessageText"))
	UTextBlock* bpv__ErrorMessageText__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="InteractionBox", Category="UI_Mei_HUD", OverrideNativeName="InteractionBox"))
	UVerticalBox* bpv__InteractionBox__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="InteractionKeyText", Category="UI_Mei_HUD", OverrideNativeName="InteractionKeyText"))
	UTextBlock* bpv__InteractionKeyText__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="InteractionObjectNameText", Category="UI_Mei_HUD", OverrideNativeName="InteractionObjectNameText"))
	UTextBlock* bpv__InteractionObjectNameText__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="InteractionSlotHachet", Category="UI_Mei_HUD", OverrideNativeName="InteractionSlotHachet"))
	UUI_Mei_InteractionSlot_C__pf4215541020* bpv__InteractionSlotHachet__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="InteractionslotMallet", Category="UI_Mei_HUD", OverrideNativeName="InteractionslotMallet"))
	UUI_Mei_InteractionSlot_C__pf4215541020* bpv__InteractionslotMallet__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="InteractionSlotPickaxe", Category="UI_Mei_HUD", OverrideNativeName="InteractionSlotPickaxe"))
	UUI_Mei_InteractionSlot_C__pf4215541020* bpv__InteractionSlotPickaxe__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="InteractionText", Category="UI_Mei_HUD", OverrideNativeName="InteractionText"))
	UTextBlock* bpv__InteractionText__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="MalletMenu", Category="UI_Mei_HUD", OverrideNativeName="MalletMenu"))
	UUI_Mei_MalletMenu_C__pf4215541020* bpv__MalletMenu__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Metalvalue", Category="UI_Mei_HUD", OverrideNativeName="Metalvalue"))
	UUI_Mei_ResourceValue_C__pf4215541020* bpv__Metalvalue__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="StoneValue", Category="UI_Mei_HUD", OverrideNativeName="StoneValue"))
	UUI_Mei_ResourceValue_C__pf4215541020* bpv__StoneValue__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="WoodValue", Category="UI_Mei_HUD", OverrideNativeName="WoodValue"))
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_ComponentBoundEvent_BuildingMenuSegmentWidget"))
	UUI_Mei_BuildingMenuSegment_C__pf4215541020* b0l__K2Node_ComponentBoundEvent_BuildingMenuSegmentWidget__pf;
	UUI_Mei_HUD_C__pf4215541020(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_6(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_7(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_8(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_9(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_UI_Mei_HUD__pf_10(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="BndEvt__UI_Mei_HUD_MalletMenu_K2Node_ComponentBoundEvent_2_OnMenuSegmentClicked__DelegateSignature"))
	virtual void bpf__BndEvt__UI_Mei_HUD_MalletMenu_K2Node_ComponentBoundEvent_2_OnMenuSegmentClicked__DelegateSignature__pf(UUI_Mei_MenuSegment_C__pf4215541020* bpp__MenuSegmentWidget__pf, bool bpp__HideMenu__pf);
	UFUNCTION(meta=(OverrideNativeName="BndEvt__UI_Mei_HUD_BuildingMenu_K2Node_ComponentBoundEvent_1_OnBuildingSegmentClicked__DelegateSignature"))
	virtual void bpf__BndEvt__UI_Mei_HUD_BuildingMenu_K2Node_ComponentBoundEvent_1_OnBuildingSegmentClicked__DelegateSignature__pf(UUI_Mei_BuildingMenuSegment_C__pf4215541020* bpp__BuildingMenuSegmentWidget__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Tooltip="Check resource component and update resources information.", Category, OverrideNativeName="UpdateResourceInformation"))
	virtual void bpf__UpdateResourceInformation__pf();
	...
	UFUNCTION(BlueprintCallable, meta=(Category="Binds", Tooltip="Executes when building messaged was received.", OverrideNativeName="Bind Building Message Received"))
	virtual void bpf__BindxBuildingxMessagexReceived__pfTTT(E__E_Mei_BuildingMode__pf bpp__BuildingMode__pf, bool bpp__InteractionResult__pf, const FText& bpp__Message__pf__const);
	UFUNCTION(BlueprintCallable, meta=(Tooltip="Show mallet menu for player.", Category, OverrideNativeName="ShowMalletMenu"))
	virtual void bpf__ShowMalletMenu__pf(ABP_Mei_Building_BaseObject_C__pf2826203124* bpp__BuildingObject__pf);
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, meta=(Category="Binds", OverrideNativeName="Bind_CrosshairVisibility"))
	virtual ESlateVisibility  bpf__Bind_CrosshairVisibility__pf();
