...
#include "ContinuePath__pf1402625666.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/NPC/ContinuePath.ContinuePath_C", OverrideNativeName="ContinuePath_C"))
class UContinuePath_C__pf1402625666 : public UBTTask_BlueprintBase
{
public:
	GENERATED_BODY()
	...
	UContinuePath_C__pf1402625666(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_ContinuePath__pf_0(int32 bpp__EntryPoint__pf);
