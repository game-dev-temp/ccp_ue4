...
#include "ANS_HeavyAttack__pf4244024795.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Mei/BP/Character/ANS_HeavyAttack.ANS_HeavyAttack_C", OverrideNativeName="ANS_HeavyAttack_C"))
class UANS_HeavyAttack_C__pf4244024795 : public UAnimNotifyState
{
public:
	GENERATED_BODY()
	UANS_HeavyAttack_C__pf4244024795(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
