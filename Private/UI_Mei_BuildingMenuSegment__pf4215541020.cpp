...
UUI_Mei_BuildingMenuSegment_C__pf4215541020::UUI_Mei_BuildingMenuSegment_C__pf4215541020(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__UpdateIconColor__pf = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UUI_Mei_BuildingMenuSegment_C__pf4215541020::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UUI_Mei_BuildingMenuSegment_C__pf4215541020::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UUI_Mei_BuildingMenuSegment_C__pf4215541020::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__1;
	SlotNames.Append(__Local__1);
}
void UUI_Mei_BuildingMenuSegment_C__pf4215541020::InitializeNativeClassData()
{
	UClass* __Local__2 = UUI_Mei_MenuSegment_C__pf4215541020::StaticClass();
	UWidgetTree* __Local__3 = CastChecked<UWidgetTree>(StaticFindObjectFast(UWidgetTree::StaticClass(), __Local__2, TEXT("WidgetTree")));
	TArray<UWidgetAnimation*>  __Local__4;
	TArray<FDelegateRuntimeBinding>  __Local__5;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), __Local__3, __Local__4, __Local__5);
}
void UUI_Mei_BuildingMenuSegment_C__pf4215541020::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UUI_Mei_BuildingMenuSegment_C__pf4215541020::bpf__UpdateWidget__pf(/*out*/ bool& bpp__Success__pf)
{
	...
	do
	{
		...
		case 5:
			{
				bpv__IconTexture__pf = bpfv__CallFunc_GetDataTableRowFromName_OutRow__pf.bpv__Icon_11_01DC2F16402C4D0E696B7BA66826D771__pf;
			}
		case 6:
			{
				Super::bpf__UpdateWidget__pf(/*out*/ bpfv__CallFunc_UpdateWidget_Success__pf);
			}
		case 7:
			{
...
PRAGMA_DISABLE_OPTIMIZATION
void UUI_Mei_BuildingMenuSegment_C__pf4215541020::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UUI_Mei_BuildingMenuSegment_C__pf4215541020::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{317, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Mei/UI/BuildingSystem/UI_Mei_MenuSegment.UI_Mei_MenuSegment_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UUI_Mei_BuildingMenuSegment_C__pf4215541020
{
	FRegisterHelper__UUI_Mei_BuildingMenuSegment_C__pf4215541020()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/UI/BuildingSystem/UI_Mei_BuildingMenuSegment"), &UUI_Mei_BuildingMenuSegment_C__pf4215541020::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UUI_Mei_BuildingMenuSegment_C__pf4215541020 Instance;
};
FRegisterHelper__UUI_Mei_BuildingMenuSegment_C__pf4215541020 FRegisterHelper__UUI_Mei_BuildingMenuSegment_C__pf4215541020::Instance;
