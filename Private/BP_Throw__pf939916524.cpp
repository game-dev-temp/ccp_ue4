...
ABP_Throw_C__pf939916524::ABP_Throw_C__pf939916524(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Throw_C__pf939916524::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_Throw_C__pf939916524::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__7 = FVector(0.200000, 0.200000, 0.200000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), false, 0));
	...
	auto& __Local__8 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), UBoxComponent::__PPO__BoxExtent() )));
	__Local__8 = FVector(50.000000, 50.000000, 50.000000);
	bpv__Box__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__9 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Box__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__9 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__10 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Box__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__11.AddUninitialized(5);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__11.GetData(), 5);
	...
	auto& __Local__16 = __Local__11[4];
	...
	auto& __Local__17 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__17 = FVector(5.000000, 5.000000, 5.000000);
...
void ABP_Throw_C__pf939916524::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Throw_C__pf939916524::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__23.FunctionNameToBind = FName(TEXT("BndEvt__BP_Throw_Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	...
	__Local__24.FunctionNameToBind = FName(TEXT("BndEvt__BP_Throw_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Throw_C__pf939916524::bpf__ExecuteUbergraph_BP_Throw__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 7);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__ProjectileMovement__pf))
	{
		bpv__ProjectileMovement__pf->Velocity = bpv__Velocity__pf;
	}
	return; // KCST_GotoReturn
}
void ABP_Throw_C__pf939916524::bpf__ExecuteUbergraph_BP_Throw__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 4);
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_DynamicCast_AsBP_Character_Mei_1__pf = Cast<ABP_Character_Mei_C__pf4244024795>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsBP_Character_Mei_1__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_1__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsBP_Character_Mei_1__pf))
	{
		b0l__K2Node_DynamicCast_AsBP_Character_Mei_1__pf->bpv__IsInCollision__pf = false;
	}
	return; // KCST_GotoReturn
}
void ABP_Throw_C__pf939916524::bpf__ExecuteUbergraph_BP_Throw__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_DynamicCast_AsBP_Character_Mei__pf = Cast<ABP_Character_Mei_C__pf4244024795>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
	...
	{
		b0l__K2Node_DynamicCast_AsBP_Character_Mei__pf->bpv__IsInCollision__pf = true;
	}
	return; // KCST_GotoReturn
}
void ABP_Throw_C__pf939916524::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_Throw__pf_0(7);
}
void ABP_Throw_C__pf939916524::bpf__BndEvt__BP_Throw_Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_BP_Throw__pf_1(4);
}
void ABP_Throw_C__pf939916524::bpf__BndEvt__BP_Throw_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_Throw__pf_2(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Throw_C__pf939916524::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Throw_C__pf939916524::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Throw_C__pf939916524
{
	FRegisterHelper__ABP_Throw_C__pf939916524()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/BP/Pickup/self/Throw/BP_Throw"), &ABP_Throw_C__pf939916524::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Throw_C__pf939916524 Instance;
};
FRegisterHelper__ABP_Throw_C__pf939916524 FRegisterHelper__ABP_Throw_C__pf939916524::Instance;
