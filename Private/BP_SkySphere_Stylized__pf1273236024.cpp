...
#include "BP_SkySphere_Stylized__pf1273236024.h"
...
ABP_SkySphere_Stylized_C__pf1273236024::ABP_SkySphere_Stylized_C__pf1273236024(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_SkySphere_Stylized_C__pf1273236024::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__SkySphereMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__SkySphereMesh__pf->OverrideMaterials.Reserve(1);
	bpv__SkySphereMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_SkySphere_Stylized_C__pf1273236024::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__Horizonxcolorxcurve__pfTT = CastChecked<UCurveLinearColor>(CastChecked<UDynamicClass>(ABP_SkySphere_Stylized_C__pf1273236024::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__Zenithxcolorxcurve__pfTT = CastChecked<UCurveLinearColor>(CastChecked<UDynamicClass>(ABP_SkySphere_Stylized_C__pf1273236024::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	bpv__Cloudxcolorxcurve__pfTT = CastChecked<UCurveLinearColor>(CastChecked<UDynamicClass>(ABP_SkySphere_Stylized_C__pf1273236024::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
...
void ABP_SkySphere_Stylized_C__pf1273236024::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_SkySphere_Stylized_C__pf1273236024::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_SkySphere_Stylized_C__pf1273236024::bpf__UserConstructionScript__pf()
{
		...
		case 1:
			{
				...
				{
					bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf = bpv__SkySphereMesh__pf->CreateDynamicMaterialInstance(0, ((UMaterialInterface*)nullptr), FName(TEXT("None")));
				}
			}
		case 2:
			{
...
void ABP_SkySphere_Stylized_C__pf1273236024::bpf__UpdateSunDirection__pf()
{
...
void ABP_SkySphere_Stylized_C__pf1273236024::bpf__RefreshMaterial__pf()
{
	float bpfv__CallFunc_Abs_ReturnValue__pf{};
	FLinearColor bpfv__CallFunc_GetClampedLinearColorValue_ReturnValue__pf(EForceInit::ForceInit);
	float bpfv__CallFunc_Lerp_ReturnValue__pf{};
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_SkySphere_Stylized_C__pf1273236024::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_SkySphere_Stylized_C__pf1273236024::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_SkySphere_Stylized_C__pf1273236024
{
	FRegisterHelper__ABP_SkySphere_Stylized_C__pf1273236024()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/BP/Terrain/BP_SkySphere_Stylized"), &ABP_SkySphere_Stylized_C__pf1273236024::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_SkySphere_Stylized_C__pf1273236024 Instance;
};
FRegisterHelper__ABP_SkySphere_Stylized_C__pf1273236024 FRegisterHelper__ABP_SkySphere_Stylized_C__pf1273236024::Instance;
