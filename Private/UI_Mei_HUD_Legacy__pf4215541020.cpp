...
#include "UI_Mei_HUD_Legacy__pf4215541020.h"
#include "GeneratedCodeHelpers.h"
#include "Runtime/UMG/Public/Blueprint/WidgetTree.h"
#include "Runtime/UMG/Public/Components/CanvasPanel.h"
#include "Runtime/UMG/Public/Components/CanvasPanelSlot.h"
#include "Runtime/UMG/Public/Components/Border.h"
#include "UI_Mei_BuildingMenu_Legacy__pf4215541020.h"
...
#include "UI_Mei_BuildingObjectButtonSlot__pf4215541020.h"
...
UUI_Mei_HUD_Legacy_C__pf4215541020::UUI_Mei_HUD_Legacy_C__pf4215541020(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__LegacyBuildingMenu__pf = nullptr;
	bpv__MalletMenu__pf = nullptr;
	bpv__Metaltvalue__pf = nullptr;
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UUI_Mei_HUD_Legacy_C__pf4215541020::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UUI_Mei_BuildingObjectButtonSlot_C__pf4215541020::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UUI_Mei_BuildingMenu_Legacy_C__pf4215541020::StaticClass());
	...
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__UI_Mei_HUD_Legacy_MalletMenu_K2Node_ComponentBoundEvent_4_OnMenuSegmentClicked__DelegateSignature"));
	auto& __Local__5 = __Local__0->ComponentDelegateBindings[1];
	__Local__5.ComponentPropertyName = FName(TEXT("LegacyBuildingMenu"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnBuildingObjectSelected"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__UI_Mei_HUD_Legacy_LegacyBuildingMenu_K2Node_ComponentBoundEvent_1_OnBuildingObjectSelected__DelegateSignature"));
	...
	auto __Local__8 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_12"), (EObjectFlags)0x00280008);
	...
	auto __Local__10 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	...
	auto __Local__11 = NewObject<UUI_Mei_BuildingMenu_Legacy_C__pf4215541020>(__Local__1, TEXT("LegacyBuildingMenu"), (EObjectFlags)0x00280008);
	__Local__11->bpv__DefaultBuildingDataTable__pf = CastChecked<UDataTable>(CastChecked<UDynamicClass>(UUI_Mei_HUD_Legacy_C__pf4215541020::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__12 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_13"), (EObjectFlags)0x00280008);
	...
	auto __Local__14 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_8"), (EObjectFlags)0x00280008);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"6132AFDF4BCBFD43CBAB4B8DD853C7E2\", \"Error Message\")")	);
	...
	auto __Local__17 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_9"), (EObjectFlags)0x00280008);
	...
	__Local__17->LayoutData.Offsets.Bottom = 200.000000f;
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"9117FBE749B04867A1E4D196DD6A4E45\", \"Target object name\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"212DBAE44B213C7E293468AB3D06F00A\", \"100 / 100\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"17928CF14EC24D4D0E335C95E718A856\", \"[ E ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"3019B90242A3E51DCB73BCA66A6AD4FA\", \"Interaction text\")")	);
	...
	auto __Local__42 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_11"), (EObjectFlags)0x00280008);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"530663CB48AA5ACACF9D38B419E08636\", \"Movement Hotkeys\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"AA42652045EB5546B6102AA3DCE8558A\", \"[ WASD ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"5A936C10411B7B8B02D52FA4B6E6236D\", \"Movement\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"E2EBFEF4494ABC50A304EC9EF2F1AB01\", \"[ Space ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"3EFE3D4F4E5B644D3EEF0CA913F56C41\", \"Jump\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"562A654940789AC9C60E39A69F5FED6F\", \"Building Hotkeys\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"FD03E189467D8D5D8B3A84946DF717A1\", \"[ Q ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"873BC1034C4C7A811AB985A6367CA496\", \"Building menu\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"E6ADC1464A7C3C3862F6B1ABC2E9093C\", \"[ T ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"933211624F2182FA34DFA1BAB8F38C69\", \"Switch to radial menu\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"751FBD654A3805D2C930C0999CC06CBD\", \"[ C ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"A36124B947C21182639E35AB8E0FBCF6\", \"Switch snapping mode\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"0E022ECA4E391359C4C3CE8A258638A3\", \"[ G ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"9D1E31904864FEEC697232AEED988F1E\", \"Switch grid mode\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"45CEA7D44669B53A8C99FC89F3EC93A6\", \"[ V ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"8F4B126540D274C37820C486C8053389\", \"Switch view mode\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"EDC5B1E340951379E1F8D18DE4012C06\", \"[ Wheel ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"B3E2F7E34D186A2E9E34B1A45D7F177E\", \"Change building rotation\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"9A1489F04B50D6C3D1C79ABFDA4FA6B8\", \"[ Shift + Wheel ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"C73C9CDE4B5691DCDF816AA125158C1D\", \"Change building height\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"48A5961F4228274B5EE0498C5A38BC21\", \"[ Page Up ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"CA7EFC3C4D73F83C3AA69D8BAB964028\", \"Increase displayed floor\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"9D096B314D2F46BA0C0FCD8B0D0F0468\", \"[ Page Down ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"8CD1EFDB45D8918DC90F22BF2940D354\", \"Decrease displayed floor\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"E3097B144EC2947896134D9743CC0CC8\", \"Other Hotkeys\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"800E3D654E16355EEEC7488B0DFD08D5\", \"[ LMB ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"F319AEFC470AD2545F4F0FA133AE84D8\", \"Damage trace\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"5E20D70941BF011ADBE8E68D3162DE06\", \"[ 1 ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"DF90E8124A11455BCF094EA2D96E8F07\", \"Select hatchet\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"5E23CCBD4DF964AEE72B7C91A9654B71\", \"[ 2 ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"B0C37E1A43E23B31E650189B61FC9920\", \"Select pickaxe\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"1409698848987BBBA58F9C858E6101B0\", \"[ 3 ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"099B10624068A87B25237CB4EE0BC1D7\", \"Select mallet\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"78C311984A2D77BAD34F169494E9DEB1\", \"[ RMB ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"BC052ACE4FA2A81AA0DE848450E7F141\", \"Mallet interaction\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"106500914AF385CADE736BA3CE9B0904\", \"[ Num1 ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"672EDF58444968F0BBAE7BA943ABAD36\", \"Save building objects\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"86B58A2246D6AA3B4784B182C69B0A4B\", \"[ Num3 ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"8DDA9F9F407C08B21BB28DA7B2B13185\", \"Load building objects\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"2737A89B4024D9C7333453B9AE68772A\", \"[ Z ]\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"FD010373439ACC9FE94E39B1550B36DA\", \"Switch debug mode\")")	);
	...
	auto __Local__253 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_14"), (EObjectFlags)0x00280008);
	...
	auto __Local__255 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_15"), (EObjectFlags)0x00280008);
	...
	auto __Local__257 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_16"), (EObjectFlags)0x00280008);
	...
	auto __Local__258 = NewObject<UUI_Mei_ResourceValue_C__pf4215541020>(__Local__1, TEXT("Metaltvalue"), (EObjectFlags)0x00280008);
	...
	auto __Local__259 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"921ACA7643D2E65C32B62CB16A521D90\", \"EBS\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"99F929A14D9ADA9817774CA57B57F4DA\", \"version 10.0\")")	);
	...
	auto __Local__273 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_3"), (EObjectFlags)0x00280008);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"608B803647520DF11156A6BAE4448294\", \"2\")")	);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"B678016145819EDA839453A46E9EA14C\", \"3\")")	);
	...
	auto __Local__282 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_4"), (EObjectFlags)0x00280008);
	...
	__Local__287 = FGuid(0x5AEA8443, 0x49F8C7E3, 0x87C96087, 0x46FC8870);
	...
	__Local__292 = FGuid(0x5AEA8443, 0x49F8C7E3, 0x87C96087, 0x46FC8870);
	...
	__Local__296 = CastChecked<UEnum>(CastChecked<UDynamicClass>(UUI_Mei_HUD_Legacy_C__pf4215541020::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__304 = CastChecked<UEnum>(CastChecked<UDynamicClass>(UUI_Mei_HUD_Legacy_C__pf4215541020::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__305 = FGuid(0x87894540, 0x404A8D9F, 0xEF3F3D80, 0x1251AA64);
	...
	__Local__306 = FGuid(0x54F638C3, 0x40F660B9, 0x386F8281, 0x407E6E00);
	...
	__Local__322 = FGuid(0x54F638C3, 0x40F660B9, 0x386F8281, 0x407E6E00);
	...
	__Local__332.InterpMode = ERichCurveInterpMode::RCIM_Linear;
	...
	__Local__336.InterpMode = ERichCurveInterpMode::RCIM_Linear;
	...
	__Local__340.InterpMode = ERichCurveInterpMode::RCIM_Linear;
	...
	__Local__348 = FGuid(0x27779A8F, 0x4B1506C1, 0xBFA822B5, 0x8642B81E);
	...
	__Local__349 = FGuid(0xE02740D0, 0x416DAF73, 0x60A3FD89, 0x1D6EEB73);
	...
	__Local__357 = FGuid(0xE02740D0, 0x416DAF73, 0x60A3FD89, 0x1D6EEB73);
	...
	__Local__376.Tangent.LeaveTangent = 0.000022f;
	__Local__376.TangentMode = ERichCurveTangentMode::RCTM_Break;
	auto& __Local__377 = __Local__374[2];
	__Local__377.Value = 1.000000f;
	__Local__377.Tangent.ArriveTangent = -0.000003f;
	__Local__377.InterpMode = ERichCurveInterpMode::RCIM_Constant;
	auto& __Local__378 = __Local__374[3];
	__Local__378.Value = 1.000000f;
	auto& __Local__379 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__361->Scale[1]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__379 = TArray<FFrameNumber> ();
	__Local__379.Reserve(4);
	__Local__379.Add(FFrameNumber{});
	__Local__379.Add(FFrameNumber{});
	__Local__379[1].Value = 15000;
	__Local__379.Add(FFrameNumber{});
	__Local__379[2].Value = 60000;
	__Local__379.Add(FFrameNumber{});
	__Local__379[3].Value = 120000;
	auto& __Local__380 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__361->Scale[1]), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__380 = TArray<FMovieSceneFloatValue> ();
	__Local__380.AddUninitialized(4);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__380.GetData(), 4);
	auto& __Local__381 = __Local__380[0];
	__Local__381.Tangent.LeaveTangent = 0.000073f;
	__Local__381.InterpMode = ERichCurveInterpMode::RCIM_Linear;
	auto& __Local__382 = __Local__380[1];
	__Local__382.Value = 1.100000f;
	__Local__382.Tangent.ArriveTangent = 0.000073f;
	__Local__382.Tangent.LeaveTangent = 0.000022f;
	__Local__382.TangentMode = ERichCurveTangentMode::RCTM_Break;
	auto& __Local__383 = __Local__380[2];
	__Local__383.Value = 1.000000f;
	__Local__383.Tangent.ArriveTangent = -0.000003f;
	__Local__383.InterpMode = ERichCurveInterpMode::RCIM_Constant;
	auto& __Local__384 = __Local__380[3];
	__Local__384.Value = 1.000000f;
	auto& __Local__385 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__361->Shear[0]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__385 = TArray<FFrameNumber> ();
	__Local__385.Reserve(1);
	__Local__385.Add(FFrameNumber{});
	__Local__385[0].Value = 120000;
	auto& __Local__386 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__361->Shear[0]), FMovieSceneFloatChannel::__PPO__Values() )));
	...
	auto& __Local__388 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__361->Shear[1]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__388 = TArray<FFrameNumber> ();
	__Local__388.Reserve(1);
	__Local__388.Add(FFrameNumber{});
	__Local__388[0].Value = 120000;
	auto& __Local__389 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__361->Shear[1]), FMovieSceneFloatChannel::__PPO__Values() )));
	...
	__Local__361->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(120000)));
	auto& __Local__391 = (*(AccessPrivateProperty<FGuid >((__Local__361), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__391 = FGuid(0xC9F1085D, 0x43CC354B, 0x72E9E390, 0xB52D051D);
	__Local__360.Add(__Local__361);
	auto& __Local__392 = (*(AccessPrivateProperty<FGuid >((__Local__358), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__392 = FGuid(0x4B9C51A6, 0x48184BA1, 0xEEAA61A0, 0xB259DEE0);
	auto& __Local__393 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__358), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__393.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__393.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__393.Entries.GetData(), 1);
	auto& __Local__394 = __Local__393.Entries[0];
	__Local__394.Section = __Local__361;
	auto& __Local__395 = (*(__Local__309->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__394.Range), 0)));
	...
	auto& __Local__397 = (*(__Local__315->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__394.Range), 0)));
	auto& __Local__398 = (*(__Local__312->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__397), 0)));
	__Local__398 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__399 = (*(__Local__319->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__397), 0)));
	__Local__399.Value = 120000;
	__Local__394.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__400 = (*(AccessPrivateProperty<FGuid >((__Local__358), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__400 = FGuid(0x4B9C51A6, 0x48184BA1, 0xEEAA61A0, 0xB259DEE0);
	__Local__294.Add(__Local__358);
	auto& __Local__401 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__284), UMovieScene::__PPO__PlaybackRange() )));
	__Local__401 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(120001)));
	auto& __Local__402 = (*(AccessPrivateProperty<FFrameRate >((__Local__284), UMovieScene::__PPO__DisplayRate() )));
	static TWeakFieldPtr<FProperty> __Local__404{};
	const FProperty* __Local__403 = __Local__404.Get();
	if (nullptr == __Local__403)
	{
		__Local__403 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameRate"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Numerator")));
		check(__Local__403);
		__Local__404 = __Local__403;
	}
	auto& __Local__405 = (*(__Local__403->ContainerPtrToValuePtr<int32 >(&(__Local__402), 0)));
	__Local__405 = 20;
	auto& __Local__406 = (*(AccessPrivateProperty<FGuid >((__Local__284), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__406 = FGuid(0xFE7F9DC9, 0x4FF13540, 0x8956EAA7, 0x76471238);
	...
	auto& __Local__407 = __Local__2->AnimationBindings[0];
	__Local__407.WidgetName = FName(TEXT("ErrorMessageText"));
	__Local__407.AnimationGuid = FGuid(0x5AEA8443, 0x49F8C7E3, 0x87C96087, 0x46FC8870);
	__Local__2->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__408 = (*(AccessPrivateProperty<FGuid >((__Local__2), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__408 = FGuid(0x9016A622, 0x45028B38, 0x301175BC, 0x55D5C2BC);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__2);
	auto __Local__409 = NewObject<UMovieScene>(__Local__3, TEXT("FadeBorderAnimation"), (EObjectFlags)0x00280008);
	auto& __Local__410 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__409), UMovieScene::__PPO__Possessables() )));
	__Local__410 = TArray<FMovieScenePossessable> ();
	__Local__410.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__410.GetData(), 1);
	auto& __Local__411 = __Local__410[0];
	auto& __Local__412 = (*(AccessPrivateProperty<FGuid >(&(__Local__411), FMovieScenePossessable::__PPO__Guid() )));
	__Local__412 = FGuid(0x86EE5A9E, 0x4CE0E1A2, 0x41DBA3A0, 0xEA0C6FE6);
	auto& __Local__413 = (*(AccessPrivateProperty<FString >(&(__Local__411), FMovieScenePossessable::__PPO__Name() )));
	__Local__413 = FString(TEXT("FadeBorder"));
	auto& __Local__414 = (*(AccessPrivateProperty<UClass* >(&(__Local__411), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__414 = UBorder::StaticClass();
	auto& __Local__415 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__409), UMovieScene::__PPO__ObjectBindings() )));
	__Local__415 = TArray<FMovieSceneBinding> ();
	__Local__415.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__415.GetData(), 1);
	auto& __Local__416 = __Local__415[0];
	auto& __Local__417 = (*(AccessPrivateProperty<FGuid >(&(__Local__416), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__417 = FGuid(0x86EE5A9E, 0x4CE0E1A2, 0x41DBA3A0, 0xEA0C6FE6);
	auto& __Local__418 = (*(AccessPrivateProperty<FString >(&(__Local__416), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__418 = FString(TEXT("FadeBorder"));
	auto& __Local__419 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__416), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__419 = TArray<UMovieSceneTrack*> ();
	__Local__419.Reserve(1);
	auto __Local__420 = NewObject<UMovieSceneColorTrack>(__Local__409, TEXT("MovieSceneColorTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__421 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__420), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__421.PropertyName = FName(TEXT("BrushColor"));
	__Local__421.PropertyPath = FName(TEXT("BrushColor"));
	__Local__421.bCanUseClassLookup = true;
	auto& __Local__422 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__420), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__422 = TArray<UMovieSceneSection*> ();
	__Local__422.Reserve(1);
	auto __Local__423 = NewObject<UMovieSceneColorSection>(__Local__420, TEXT("MovieSceneColorSection_0"), (EObjectFlags)0x00280008);
	auto __Local__424 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__423->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__425 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__423->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__424)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__426 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__423), UMovieSceneColorSection::__PPO__RedCurve() )));
	auto& __Local__427 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__426), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__427 = TArray<FFrameNumber> ();
	__Local__427.Reserve(1);
	__Local__427.Add(FFrameNumber{});
	auto& __Local__428 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__426), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__428 = TArray<FMovieSceneFloatValue> ();
	__Local__428.AddUninitialized(1);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__428.GetData(), 1);
	auto& __Local__429 = __Local__428[0];
	auto& __Local__430 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__423), UMovieSceneColorSection::__PPO__GreenCurve() )));
	auto& __Local__431 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__430), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__431 = TArray<FFrameNumber> ();
	__Local__431.Reserve(1);
	__Local__431.Add(FFrameNumber{});
	auto& __Local__432 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__430), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__432 = TArray<FMovieSceneFloatValue> ();
	__Local__432.AddUninitialized(1);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__432.GetData(), 1);
	auto& __Local__433 = __Local__432[0];
	auto& __Local__434 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__423), UMovieSceneColorSection::__PPO__BlueCurve() )));
	auto& __Local__435 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__434), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__435 = TArray<FFrameNumber> ();
	__Local__435.Reserve(1);
	__Local__435.Add(FFrameNumber{});
	auto& __Local__436 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__434), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__436 = TArray<FMovieSceneFloatValue> ();
	__Local__436.AddUninitialized(1);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__436.GetData(), 1);
	auto& __Local__437 = __Local__436[0];
	auto& __Local__438 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__423), UMovieSceneColorSection::__PPO__AlphaCurve() )));
	auto& __Local__439 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__438), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__439 = TArray<FFrameNumber> ();
	__Local__439.Reserve(2);
	__Local__439.Add(FFrameNumber{});
	__Local__439.Add(FFrameNumber{});
	__Local__439[1].Value = 15000;
	auto& __Local__440 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__438), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__440 = TArray<FMovieSceneFloatValue> ();
	__Local__440.AddUninitialized(2);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__440.GetData(), 2);
	auto& __Local__441 = __Local__440[0];
	auto& __Local__442 = __Local__440[1];
	__Local__442.Value = 0.625000f;
	__Local__423->Easing.EaseIn = __Local__424;
	__Local__423->Easing.EaseOut = __Local__425;
	__Local__423->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(15000)));
	auto& __Local__443 = (*(AccessPrivateProperty<FGuid >((__Local__423), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__443 = FGuid(0x35464D50, 0x498E0E49, 0x9CA11388, 0xF7F19D53);
	__Local__422.Add(__Local__423);
	auto& __Local__444 = (*(AccessPrivateProperty<FGuid >((__Local__420), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__444 = FGuid(0x41861940, 0x4017B7F7, 0xADFFAFB8, 0xF8A9A974);
	auto& __Local__445 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__420), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__445.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__445.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__445.Entries.GetData(), 1);
	auto& __Local__446 = __Local__445.Entries[0];
	__Local__446.Section = __Local__423;
	auto& __Local__447 = (*(__Local__309->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__446.Range), 0)));
	...
	auto& __Local__449 = (*(__Local__315->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__446.Range), 0)));
	auto& __Local__450 = (*(__Local__312->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__449), 0)));
	__Local__450 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__451 = (*(__Local__319->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__449), 0)));
	__Local__451.Value = 15000;
	__Local__446.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__452 = (*(AccessPrivateProperty<FGuid >((__Local__420), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__452 = FGuid(0x41861940, 0x4017B7F7, 0xADFFAFB8, 0xF8A9A974);
	__Local__419.Add(__Local__420);
	auto& __Local__453 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__409), UMovieScene::__PPO__PlaybackRange() )));
	__Local__453 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(15001)));
	auto& __Local__454 = (*(AccessPrivateProperty<FFrameRate >((__Local__409), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__455 = (*(__Local__403->ContainerPtrToValuePtr<int32 >(&(__Local__454), 0)));
	__Local__455 = 20;
	auto& __Local__456 = (*(AccessPrivateProperty<FGuid >((__Local__409), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__456 = FGuid(0x607B3D2A, 0x477391F6, 0xA9D3E6AE, 0xE3B0098D);
	__Local__3->MovieScene = __Local__409;
	...
	auto& __Local__457 = __Local__3->AnimationBindings[0];
	__Local__457.WidgetName = FName(TEXT("FadeBorder"));
	__Local__457.AnimationGuid = FGuid(0x86EE5A9E, 0x4CE0E1A2, 0x41DBA3A0, 0xEA0C6FE6);
	__Local__3->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__458 = (*(AccessPrivateProperty<FGuid >((__Local__3), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__458 = FGuid(0xF78E8D14, 0x408F8755, 0xF47A3AA3, 0x67560627);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__3);
}
PRAGMA_ENABLE_OPTIMIZATION
void UUI_Mei_HUD_Legacy_C__pf4215541020::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__459;
	SlotNames.Append(__Local__459);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__460;
	__Local__460.Reserve(2);
	__Local__460.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(UUI_Mei_HUD_Legacy_C__pf4215541020::StaticClass())->MiscConvertedSubobjects[1]));
	__Local__460.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(UUI_Mei_HUD_Legacy_C__pf4215541020::StaticClass())->MiscConvertedSubobjects[2]));
	TArray<FDelegateRuntimeBinding>  __Local__461;
	__Local__461.AddUninitialized(4);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__461.GetData(), 4);
	auto& __Local__462 = __Local__461[0];
	__Local__462.ObjectName = FString(TEXT("InteractionObjectNameText"));
	__Local__462.PropertyName = FName(TEXT("Text"));
	__Local__462.FunctionName = FName(TEXT("Get_InteractionObjectNameText_Text_0"));
	auto& __Local__463 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__462.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__463 = TArray<FPropertyPathSegment> ();
	__Local__463.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__463.GetData(), 1);
	auto& __Local__464 = __Local__463[0];
	__Local__464.Name = FName(TEXT("Bind_UpdateTargetActorName"));
	auto& __Local__465 = __Local__461[1];
	__Local__465.ObjectName = FString(TEXT("DurabilityText"));
	__Local__465.PropertyName = FName(TEXT("Text"));
	__Local__465.FunctionName = FName(TEXT("Get_DurabilityText_Text_0"));
	auto& __Local__466 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__465.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__466 = TArray<FPropertyPathSegment> ();
	__Local__466.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__466.GetData(), 1);
	auto& __Local__467 = __Local__466[0];
	__Local__467.Name = FName(TEXT("Bind_UpdateTargetActorDurability"));
	auto& __Local__468 = __Local__461[2];
	__Local__468.ObjectName = FString(TEXT("InteractionText"));
	__Local__468.PropertyName = FName(TEXT("Text"));
	__Local__468.FunctionName = FName(TEXT("Get_InteractionText_Text_0"));
	auto& __Local__469 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__468.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__469 = TArray<FPropertyPathSegment> ();
	__Local__469.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__469.GetData(), 1);
	auto& __Local__470 = __Local__469[0];
	__Local__470.Name = FName(TEXT("Bind_UpdateTargetActorInteractionText"));
	auto& __Local__471 = __Local__461[3];
	__Local__471.ObjectName = FString(TEXT("CrosshairImage"));
	__Local__471.PropertyName = FName(TEXT("Visibility"));
	__Local__471.FunctionName = FName(TEXT("Get_CrosshairImage_Visibility_0"));
	auto& __Local__472 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__471.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__472 = TArray<FPropertyPathSegment> ();
	__Local__472.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__472.GetData(), 1);
	auto& __Local__473 = __Local__472[0];
	__Local__473.Name = FName(TEXT("Bind_UpdateCrosshairVisibility"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UUI_Mei_HUD_Legacy_C__pf4215541020::StaticClass())->MiscConvertedSubobjects[0]), __Local__460, __Local__461);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		auto __Local__475 = FDataTableRowHandle{};
		FDataTableRowHandle  __Local__474 = __Local__475;
		IBPI_Mei_Player_C::Execute_bpf__TryStartBuildObject_BPI__pf(b0l__K2Node_DynamicCast_AsBPI_Mei_Player__pf.GetObject() , ((::IsValid(b0l__K2Node_ComponentBoundEvent_BuildingObjectButtonWidget__pf)) ? (b0l__K2Node_ComponentBoundEvent_BuildingObjectButtonWidget__pf->bpv__BuildingObjectHandle__pf) : (__Local__474)));
	}
	return; // KCST_GotoReturn
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_1(int32 bpp__EntryPoint__pf)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_2(int32 bpp__EntryPoint__pf)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_3(int32 bpp__EntryPoint__pf)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_4(int32 bpp__EntryPoint__pf)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_5(int32 bpp__EntryPoint__pf)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_6(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 17);
	// optimized KCST_UnconditionalGoto
	bpf__ShowxMalletxMenu__pfTT(b0l__K2Node_Event_BuildingObject__pf);
	return; // KCST_GotoReturn
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_7(int32 bpp__EntryPoint__pf)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_8(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 5);
	// optimized KCST_UnconditionalGoto
	bpf__UpdateInteractionSlots__pf();
	// optimized KCST_UnconditionalGoto
	bpf__UpdateResourcesInformation__pf();
	return; // KCST_GotoReturn
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_9(int32 bpp__EntryPoint__pf)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_10(int32 bpp__EntryPoint__pf)
{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__BndEvt__UI_Mei_HUD_Legacy_MalletMenu_K2Node_ComponentBoundEvent_4_OnMenuSegmentClicked__DelegateSignature__pf(UUI_Mei_MenuSegment_C__pf4215541020* bpp__MenuSegmentWidget__pf, bool bpp__HideMenu__pf)
{
	...
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_10(1);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__BndEvt__UI_Mei_HUD_Legacy_LegacyBuildingMenu_K2Node_ComponentBoundEvent_1_OnBuildingObjectSelected__DelegateSignature__pf(UUI_Mei_BuildingObjectButtonSlot_C__pf4215541020* bpp__BuildingObjectButtonWidget__pf)
{
	b0l__K2Node_ComponentBoundEvent_BuildingObjectButtonWidget__pf = bpp__BuildingObjectButtonWidget__pf;
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_0(26);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__HideMalletMenu_BPI__pf()
{
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_2(25);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__UpdateBuildingList_BPI__pf(FDataTableRowHandle bpp__BuildingListHandle__pf)
{
	b0l__K2Node_Event_BuildingListHandle__pf = bpp__BuildingListHandle__pf;
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_1(23);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__HideBuildingMenu_BPI__pf()
{
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_3(22);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ShowBuildingMenu_BPI__pf()
{
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_5(21);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__SetBuildingComponentReference_BPI__pf(UBP_Mei_BuildingComponent_C__pf1731449071* bpp__BuildingComponent__pf)
{
	b0l__K2Node_Event_BuildingComponent__pf = bpp__BuildingComponent__pf;
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_4(19);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ShowMalletMenu_BPI__pf(ABP_Mei_Building_BaseObject_C__pf2826203124* bpp__BuildingObject__pf)
{
	b0l__K2Node_Event_BuildingObject__pf = bpp__BuildingObject__pf;
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_6(17);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__SetInteractionComponentReference_BPI__pf(UBP_Mei_InteractionComponent_C__pf1731449071* bpp__InteractionComponent__pf)
{
	b0l__K2Node_Event_InteractionComponent__pf = bpp__InteractionComponent__pf;
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_7(15);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_9(8);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b0l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b0l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_UI_Mei_HUD_Legacy__pf_8(5);
}
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ShowBuildingMenu__pf()
{
		...
		case 1:
			{
				...
				if(::IsValid(bpv__LegacyBuildingMenu__pf))
				{
					bpfv__CallFunc_IsVisible_ReturnValue_1__pf = bpv__LegacyBuildingMenu__pf->UWidget::IsVisible();
				}
		...
		case 4:
			{
				if(::IsValid(bpv__LegacyBuildingMenu__pf))
				{
					bpv__LegacyBuildingMenu__pf->SetVisibility(ESlateVisibility::Visible);
				}
			}
		case 5:
			{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__HideBuildingMenu__pf()
{
	UUMGSequencePlayer* bpfv__CallFunc_PlayAnimation_ReturnValue__pf{};
	APlayerController* bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf{};
	APawn* bpfv__CallFunc_K2_GetPawn_ReturnValue__pf{};
	...
	do
	{
		...
		case 1:
			{
				if(::IsValid(bpv__LegacyBuildingMenu__pf))
				{
					bpfv__CallFunc_IsVisible_ReturnValue__pf = bpv__LegacyBuildingMenu__pf->UWidget::IsVisible();
				}
		...
		case 2:
			{
				if(::IsValid(bpv__LegacyBuildingMenu__pf))
				{
					bpv__LegacyBuildingMenu__pf->SetVisibility(ESlateVisibility::Hidden);
				}
			}
		case 3:
			{
		...
		case 4:
			{
				bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf = GetOwningPlayer();
				bool  __Local__476 = false;
				if(::IsValid(bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf))
				{
					bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf->bShowMouseCursor = ((::IsValid(bpv__BuildingComponent__pf)) ? (bpv__BuildingComponent__pf->bpv__TraceToMouseMode__pf) : (__Local__476));
				}
			}
		case 5:
			{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__UpdateBuildingList__pf(FDataTableRowHandle bpp__BuildingListHandle__pf)
{
	bool bpfv__CallFunc_UpdateBuildingList_Success__pf{};
	if(::IsValid(bpv__LegacyBuildingMenu__pf))
	{
		bpv__LegacyBuildingMenu__pf->bpf__UpdateBuildingList__pf(bpp__BuildingListHandle__pf, /*out*/ bpfv__CallFunc_UpdateBuildingList_Success__pf);
	}
}
FText  UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__Bind_UpdateTargetActorName__pf()
{
		...
		case 5:
			{
				...
				bpfv__CallFunc_NotEqual_ByteByte_ReturnValue__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpfv__CallFunc_GetInteractionStatus_BuildingMode__pf), static_cast<uint8>(E__E_Mei_BuildingMode__pf::NewEnumerator1));
		...
		case 7:
			{
				...
				FText  __Local__477 = FText::GetEmpty();
				bpp__ReturnValue__pf = ((::IsValid(bpfv__CallFunc_GetInteractionStatus_TargetBuildingObject__pf)) ? (bpfv__CallFunc_GetInteractionStatus_TargetBuildingObject__pf->bpv__BuildingObjectSettings__pf.bpv__Name_5_9117448A4C5B6B9761439D9BD7AA8488__pf) : (__Local__477));
				__CurrentState = -1;
				break;
			}
		case 8:
		...
		case 12:
			{
				...
				{
					const UScriptStruct* __Local__479 = FKey::StaticStruct();
					uint8* __Local__480 = (uint8*)FMemory_Alloca(__Local__479->GetStructureSize());
					__Local__479->InitializeStruct(__Local__480);
					FKey& __Local__478 = *reinterpret_cast<FKey*>(__Local__480);
					IBPI_Mei_InteractionObject_C::Execute_bpf__IsCanInteract_BPI__pf(bpfv__K2Node_DynamicCast_AsBPI_Mei_Interaction_Object_1__pf.GetObject() , __Local__478, bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf, /*out*/ bpfv__CallFunc_IsCanInteract_BPI_Result__pf);
				}
			}
		case 13:
			{
...
FText  UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__Bind_UpdateTargetActorDurability__pf()
{
	FText bpp__ReturnValue__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue_1__pf{};
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"27E4875F467A45C14AFEDCAD6659B08D\", \"{Durability} / {MaxDurability}\")")	), bpfv__K2Node_MakeArray_Array__pf);
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"4F4392954CF38A989F17D19661446DBC\", \"{Durability} / {MaxDurability}\")")	), bpfv__K2Node_MakeArray_Array_1__pf);
...
FText  UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__Bind_UpdateTargetActorInteractionText__pf()
{
	FText bpp__ReturnValue__pf{};
	...
	do
	{
		...
		case 5:
			{
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpfv__LocalBuildingMode__pf), static_cast<uint8>(E__E_Mei_BuildingMode__pf::NewEnumerator1));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpfv__LocalBuildingMode__pf), static_cast<uint8>(E__E_Mei_BuildingMode__pf::NewEnumerator2));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 22;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpfv__LocalBuildingMode__pf), static_cast<uint8>(E__E_Mei_BuildingMode__pf::NewEnumerator3));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 22;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpfv__LocalBuildingMode__pf), static_cast<uint8>(E__E_Mei_BuildingMode__pf::NewEnumerator4));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 22;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpfv__LocalBuildingMode__pf), static_cast<uint8>(E__E_Mei_BuildingMode__pf::NewEnumerator5));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 22;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpfv__LocalBuildingMode__pf), static_cast<uint8>(E__E_Mei_BuildingMode__pf::NewEnumerator6));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 22;
					break;
		...
		case 10:
			{
				...
				if(::IsValid(bpfv__K2Node_DynamicCast_AsBPI_Mei_Interaction_Object_1__pf))
				{
					const UScriptStruct* __Local__482 = FKey::StaticStruct();
					uint8* __Local__483 = (uint8*)FMemory_Alloca(__Local__482->GetStructureSize());
					__Local__482->InitializeStruct(__Local__483);
					FKey& __Local__481 = *reinterpret_cast<FKey*>(__Local__483);
					IBPI_Mei_InteractionObject_C::Execute_bpf__IsCanInteract_BPI__pf(bpfv__K2Node_DynamicCast_AsBPI_Mei_Interaction_Object_1__pf.GetObject() , __Local__481, bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf, /*out*/ bpfv__CallFunc_IsCanInteract_BPI_Result__pf);
				}
			}
		case 11:
			{
		...
		case 13:
			{
				...
				if(::IsValid(bpfv__K2Node_DynamicCast_AsBPI_Mei_Interaction_Object__pf))
				{
					const UScriptStruct* __Local__485 = FKey::StaticStruct();
					uint8* __Local__486 = (uint8*)FMemory_Alloca(__Local__485->GetStructureSize());
					__Local__485->InitializeStruct(__Local__486);
					FKey& __Local__484 = *reinterpret_cast<FKey*>(__Local__486);
					IBPI_Mei_InteractionObject_C::Execute_bpf__GetInteractionText_BPI__pf(bpfv__K2Node_DynamicCast_AsBPI_Mei_Interaction_Object__pf.GetObject() , __Local__484, bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf, /*out*/ bpfv__CallFunc_GetInteractionText_BPI_InteractionText__pf);
				}
			}
		case 14:
			{
				...
				{
					bpv__InteractionText__pf->SetVisibility(TSwitchValue<bool , ESlateVisibility >(bpfv__Temp_bool_Variable__pf, bpfv__K2Node_Select_Default__pf, 2, TSwitchPair<bool , ESlateVisibility >(false, bpfv__Temp_byte_Variable_1__pf), TSwitchPair<bool , ESlateVisibility >(true, bpfv__Temp_byte_Variable__pf)));
				}
				if(::IsValid(bpv__InteractionKeyText__pf))
				{
					bpv__InteractionKeyText__pf->SetVisibility(TSwitchValue<bool , ESlateVisibility >(bpfv__Temp_bool_Variable__pf, bpfv__K2Node_Select_Default__pf, 2, TSwitchPair<bool , ESlateVisibility >(false, bpfv__Temp_byte_Variable_1__pf), TSwitchPair<bool , ESlateVisibility >(true, bpfv__Temp_byte_Variable__pf)));
				}
			}
		case 15:
			{
		...
		case 19:
			{
				bpfv__CallFunc_IsValid_ReturnValue_2__pf = UKismetSystemLibrary::IsValid(bpfv__LocalBuildingObject__pf);
				if (!bpfv__CallFunc_IsValid_ReturnValue_2__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
...
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"30E3E8F7484FE39700A3E7ACFDEC464B\", \"Repair\")")	);
				bpfv__Temp_text_Variable_1__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"79579FDF4606F8F6686A19BFA42409C2\", \"Build\")")	);
				bpfv__Temp_text_Variable_2__pf = FText::GetEmpty();
				bpfv__Temp_text_Variable_3__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"4B3DF114441398CFEDABF6B195449D39\", \"Upgrade\")")	);
				bpfv__Temp_text_Variable_4__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"5397106E47AC0D246829CA80A0407FA9\", \"Destruct\")")	);
				bpfv__Temp_text_Variable_5__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"D1CAB3FC44BDBCEDBBBA7B8ABDD60D70\", \"Remove\")")	);
				bpfv__Temp_text_Variable_6__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"8C1E620C49AA5AD934B522922579D69D\", \"Rotate\")")	);
				...
				FText  __Local__487 = FText::GetEmpty();
				bpfv__K2Node_MakeStruct_FormatArgumentData__pf.ArgumentValue = ((::IsValid(bpfv__LocalBuildingObject__pf)) ? (bpfv__LocalBuildingObject__pf->bpv__BuildingObjectSettings__pf.bpv__Name_5_9117448A4C5B6B9761439D9BD7AA8488__pf) : (__Local__487));
				bpfv__K2Node_MakeStruct_FormatArgumentData__pf.ArgumentValueInt = 0;
				...
				bpfv__K2Node_MakeArray_Array__pf[1] = bpfv__K2Node_MakeStruct_FormatArgumentData__pf;
				bpfv__CallFunc_Format_ReturnValue__pf = UKismetTextLibrary::Format(FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[8EE4604846D158043EE6C3BBEDBD11D4]\", \"7DAE9E63415009ED8E8BC0B134E3CDDB\", \"{BuildingMode} {ObjectName}\")")	), bpfv__K2Node_MakeArray_Array__pf);
				bpp__ReturnValue__pf = bpfv__CallFunc_Format_ReturnValue__pf;
				__CurrentState = -1;
				break;
			}
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__SetBuildingComponentReference__pf(UBP_Mei_BuildingComponent_C__pf1731449071* bpp__BuildingComponent__pf)
{
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue_1__pf{};
	int32 __CurrentState = 1;
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__SetInteractionComponentReference__pf(UBP_Mei_InteractionComponent_C__pf1731449071* bpp__InteractionComponent__pf)
{
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue_1__pf{};
	int32 __CurrentState = 1;
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__Bind_BuildingMessageReceived__pf(E__E_Mei_BuildingMode__pf bpp__BuildingMode__pf, bool bpp__InteractionResult__pf, const FText& bpp__Message__pf__const)
{
	typedef FText  T__Local__488;
	T__Local__488& bpp__Message__pf = *const_cast<T__Local__488 *>(&bpp__Message__pf__const);
	bool bpfv__CallFunc_Not_PreBool_ReturnValue__pf{};
	UUMGSequencePlayer* bpfv__CallFunc_PlayAnimation_ReturnValue__pf{};
	int32 __CurrentState = 1;
	do
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__UpdateResourcesInformation__pf()
{
	APlayerController* bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf{};
	...
	float bpfv__CallFunc_GetResourceValue_Value_1__pf{};
	float bpfv__CallFunc_GetResourceValue_Value_2__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	int32 __CurrentState = 1;
	do
	{
		...
		case 2:
			{
				...
				{
					bpv__ResourceComponent__pf->bpf__GetResourceValue__pf(E__E_Mei_ResourceType__pf::NewEnumerator0, /*out*/ bpfv__CallFunc_GetResourceValue_Value_2__pf);
				}
				if(::IsValid(bpv__WoodValue__pf))
				{
					bpv__WoodValue__pf->bpf__SetResourceValue__pf(bpfv__CallFunc_GetResourceValue_Value_2__pf);
				}
			}
		case 3:
			{
				if(::IsValid(bpv__ResourceComponent__pf))
				{
					bpv__ResourceComponent__pf->bpf__GetResourceValue__pf(E__E_Mei_ResourceType__pf::NewEnumerator1, /*out*/ bpfv__CallFunc_GetResourceValue_Value_1__pf);
				}
				if(::IsValid(bpv__Stonevalue__pf))
				{
					bpv__Stonevalue__pf->bpf__SetResourceValue__pf(bpfv__CallFunc_GetResourceValue_Value_1__pf);
				}
			}
		case 4:
			{
				if(::IsValid(bpv__ResourceComponent__pf))
				{
					bpv__ResourceComponent__pf->bpf__GetResourceValue__pf(E__E_Mei_ResourceType__pf::NewEnumerator2, /*out*/ bpfv__CallFunc_GetResourceValue_Value__pf);
				}
				if(::IsValid(bpv__Metaltvalue__pf))
				{
					bpv__Metaltvalue__pf->bpf__SetResourceValue__pf(bpfv__CallFunc_GetResourceValue_Value__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__ShowxMalletxMenu__pfTT(ABP_Mei_Building_BaseObject_C__pf2826203124* bpp__BuildingObject__pf)
{
	UUMGSequencePlayer* bpfv__CallFunc_PlayAnimation_ReturnValue__pf{};
	bool bpfv__CallFunc_IsVisible_ReturnValue__pf{};
	bool bpfv__CallFunc_Not_PreBool_ReturnValue__pf{};
	...
	bool bpfv__CallFunc_IsVisible_ReturnValue_1__pf{};
	bool bpfv__CallFunc_Not_PreBool_ReturnValue_1__pf{};
	bool bpfv__CallFunc_SetBuildingObjectReference_Success__pf{};
	bool bpfv__CallFunc_BooleanAND_ReturnValue__pf{};
	int32 __CurrentState = 1;
	do
	{
		...
		case 1:
			{
				...
				if(::IsValid(bpv__MalletMenu__pf))
				{
					bpfv__CallFunc_IsVisible_ReturnValue_1__pf = bpv__MalletMenu__pf->UWidget::IsVisible();
				}
				bpfv__CallFunc_Not_PreBool_ReturnValue_1__pf = UKismetMathLibrary::Not_PreBool(bpfv__CallFunc_IsVisible_ReturnValue_1__pf);
				bpfv__CallFunc_BooleanAND_ReturnValue__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_Not_PreBool_ReturnValue_1__pf, bpfv__CallFunc_Not_PreBool_ReturnValue__pf);
				if (!bpfv__CallFunc_BooleanAND_ReturnValue__pf)
		...
		case 2:
			{
				if(::IsValid(bpv__MalletMenu__pf))
				{
					bpv__MalletMenu__pf->bpf__SetBuildingObjectReference__pf(bpp__BuildingObject__pf, /*out*/ bpfv__CallFunc_SetBuildingObjectReference_Success__pf);
				}
			}
		case 3:
			{
		...
		case 5:
			{
				if(::IsValid(bpv__MalletMenu__pf))
				{
					bpv__MalletMenu__pf->SetVisibility(ESlateVisibility::Visible);
				}
			}
		case 6:
			{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__HideMalletMenu__pf()
{
	UUMGSequencePlayer* bpfv__CallFunc_PlayAnimation_ReturnValue__pf{};
	bool bpfv__CallFunc_IsVisible_ReturnValue__pf{};
	APlayerController* bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf{};
		...
		case 4:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf))
				{
					bpfv__CallFunc_GetOwningPlayer_ReturnValue__pf->bShowMouseCursor = ((::IsValid(bpv__BuildingComponent__pf)) ? (bpv__BuildingComponent__pf->bpv__TraceToMouseMode__pf) : (__Local__489));
				}
			}
		case 5:
			{
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__UpdateInteractionSlots__pf()
{
	UUI_Mei_InteractionSlot_C__pf4215541020* bpfv__Temp_object_Variable__pf{};
	UUI_Mei_InteractionSlot_C__pf4215541020* bpfv__Temp_object_Variable_1__pf{};
	UUI_Mei_InteractionSlot_C__pf4215541020* bpfv__Temp_object_Variable_2__pf{};
	UUI_Mei_InteractionSlot_C__pf4215541020* bpfv__Temp_object_Variable_3__pf{};
		...
		case 3:
			{
				...
				bpfv__Temp_object_Variable_1__pf = ((UUI_Mei_InteractionSlot_C__pf4215541020*)nullptr);
				bpfv__Temp_object_Variable_2__pf = ((UUI_Mei_InteractionSlot_C__pf4215541020*)nullptr);
				bpfv__Temp_object_Variable_3__pf = ((UUI_Mei_InteractionSlot_C__pf4215541020*)nullptr);
				if(::IsValid(bpv__InteractionComponent__pf))
				{
				...
				bpfv__Temp_byte_Variable__pf = static_cast<uint8>(bpfv__CallFunc_GetInteractionStance_InteractionStance__pf);
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(TSwitchValue<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(bpfv__Temp_byte_Variable__pf, bpfv__K2Node_Select_Default__pf, 4, TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(0, bpfv__Temp_object_Variable_3__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(1, bpfv__Temp_object_Variable_2__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(2, bpfv__Temp_object_Variable_1__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(3, bpfv__Temp_object_Variable__pf)));
				if (!bpfv__CallFunc_IsValid_ReturnValue_1__pf)
				{
					__CurrentState = -1;
					break;
		...
		case 4:
			{
				...
				bpfv__Temp_byte_Variable__pf = static_cast<uint8>(bpfv__CallFunc_GetInteractionStance_InteractionStance__pf);
				if(::IsValid(TSwitchValue<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(bpfv__Temp_byte_Variable__pf, bpfv__K2Node_Select_Default__pf, 4, TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(0, bpfv__Temp_object_Variable_3__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(1, bpfv__Temp_object_Variable_2__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(2, bpfv__Temp_object_Variable_1__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(3, bpfv__Temp_object_Variable__pf))))
				{
					TSwitchValue<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(bpfv__Temp_byte_Variable__pf, bpfv__K2Node_Select_Default__pf, 4, TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(0, bpfv__Temp_object_Variable_3__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(1, bpfv__Temp_object_Variable_2__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(2, bpfv__Temp_object_Variable_1__pf), TSwitchPair<uint8 , UUI_Mei_InteractionSlot_C__pf4215541020* >(3, bpfv__Temp_object_Variable__pf))->bpf__SetSelection__pf(true, /*out*/ bpfv__CallFunc_SetSelection_Success_1__pf);
				}
				__CurrentState = -1;
				break;
			}
...
ESlateVisibility  UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__Bind_UpdateCrosshairVisibility__pf()
{
	...
	bpfv__CallFunc_BooleanOR_ReturnValue__pf = UKismetMathLibrary::BooleanOR(bpfv__CallFunc_IsVisible_ReturnValue__pf, bpfv__CallFunc_IsVisible_ReturnValue_1__pf);
...
void UUI_Mei_HUD_Legacy_C__pf4215541020::bpf__SetMousePositionToCenter__pf()
{
	...
	do
	{
		...
		case 1:
			{
				bool  __Local__490 = false;
				bpfv__CallFunc_Not_PreBool_ReturnValue__pf = UKismetMathLibrary::Not_PreBool(((::IsValid(bpv__BuildingComponent__pf)) ? (bpv__BuildingComponent__pf->bpv__TraceToMouseMode__pf) : (__Local__490)));
				if (!bpfv__CallFunc_Not_PreBool_ReturnValue__pf)
				{
					__CurrentState = -1;
					break;
...
PRAGMA_DISABLE_OPTIMIZATION
void UUI_Mei_HUD_Legacy_C__pf4215541020::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UUI_Mei_HUD_Legacy_C__pf4215541020::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{446, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Mei/UI/BuildingSystem/UI_Mei_BuildingObjectButtonSlot.UI_Mei_BuildingObjectButtonSlot_C 
		{447, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Mei/UI/BuildingSystem/UI_Mei_BuildingMenu_Legacy.UI_Mei_BuildingMenu_Legacy_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UUI_Mei_HUD_Legacy_C__pf4215541020
{
	FRegisterHelper__UUI_Mei_HUD_Legacy_C__pf4215541020()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/UI/BuildingSystem/UI_Mei_HUD_Legacy"), &UUI_Mei_HUD_Legacy_C__pf4215541020::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UUI_Mei_HUD_Legacy_C__pf4215541020 Instance;
};
FRegisterHelper__UUI_Mei_HUD_Legacy_C__pf4215541020 FRegisterHelper__UUI_Mei_HUD_Legacy_C__pf4215541020::Instance;
