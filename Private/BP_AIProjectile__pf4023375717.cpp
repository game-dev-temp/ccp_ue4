...
ABP_AIProjectile_C__pf4023375717::ABP_AIProjectile_C__pf4023375717(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = ECollisionChannel::ECC_GameTraceChannel2;
	...
	__Local__4.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__4.GetData(), 10);
	...
	__Local__13.Channel = FName(TEXT("Pickups"));
	__Local__13.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__14 = __Local__4[9];
	__Local__14.Channel = FName(TEXT("Projectile"));
	...
	bpv__Niagara__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	...
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Niagara__pf), false, 0));
	...
	bpv__HItx__pfzy = false;
	bpv__HItEmitter__pf = nullptr;
...
void ABP_AIProjectile_C__pf4023375717::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AIProjectile_C__pf4023375717::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto& __Local__18 = __Local__17->ComponentDelegateBindings[0];
	__Local__18.ComponentPropertyName = FName(TEXT("Sphere"));
	__Local__18.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__18.FunctionNameToBind = FName(TEXT("BndEvt__BP_AIProjectile_Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_AIProjectile_C__pf4023375717::bpf__ExecuteUbergraph_BP_AIProjectile__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 7:
			{
				bpv__HItx__pfzy = true;
			}
		case 8:
			{
				bpfv__CallFunc_GetOwner_ReturnValue__pf = AActor::GetOwner();
				bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_ComponentBoundEvent_OtherActor__pf, bpv__Damage__pf, ((AController*)nullptr), bpfv__CallFunc_GetOwner_ReturnValue__pf, UDamageType::StaticClass());
				__CurrentState = 6;
				break;
			}
		case 9:
		...
		case 13:
			{
				...
				{
					bpfv__CallFunc_ActorHasTag_ReturnValue_1__pf = b0l__K2Node_ComponentBoundEvent_OtherActor__pf->AActor::ActorHasTag(FName(TEXT("Player")));
				}
		...
		case 14:
			{
				if(::IsValid(b0l__K2Node_ComponentBoundEvent_OtherActor__pf))
				{
					bpfv__CallFunc_ActorHasTag_ReturnValue__pf = b0l__K2Node_ComponentBoundEvent_OtherActor__pf->AActor::ActorHasTag(FName(TEXT("Enemy")));
				}
...
void ABP_AIProjectile_C__pf4023375717::bpf__ExecuteUbergraph_BP_AIProjectile__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpf__Multi_SpawnFX__pf(bpv__HItEmitter__pf, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf);
	return; // KCST_GotoReturn
}
void ABP_AIProjectile_C__pf4023375717::bpf__ExecuteUbergraph_BP_AIProjectile__pf_2(int32 bpp__EntryPoint__pf)
{
	UNiagaraComponent* bpfv__CallFunc_SpawnSystemAtLocation_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_SpawnSystemAtLocation_ReturnValue__pf = UNiagaraFunctionLibrary::SpawnSystemAtLocation(this, b0l__K2Node_CustomEvent_EmitterTemplate__pf, b0l__K2Node_CustomEvent_Location__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000), true, true, ENCPoolMethod::None, true);
	return; // KCST_GotoReturn
}
void ABP_AIProjectile_C__pf4023375717::bpf__BndEvt__BP_AIProjectile_Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_AIProjectile__pf_0(11);
}
void ABP_AIProjectile_C__pf4023375717::bpf__ReceiveDestroyed__pf()
{
	bpf__ExecuteUbergraph_BP_AIProjectile__pf_1(3);
}
void ABP_AIProjectile_C__pf4023375717::bpf__Multi_SpawnFX__pf_Implementation(UNiagaraSystem* bpp__EmitterTemplate__pf, FVector bpp__Location__pf)
{
	b0l__K2Node_CustomEvent_EmitterTemplate__pf = bpp__EmitterTemplate__pf;
	b0l__K2Node_CustomEvent_Location__pf = bpp__Location__pf;
	bpf__ExecuteUbergraph_BP_AIProjectile__pf_2(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AIProjectile_C__pf4023375717::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AIProjectile_C__pf4023375717::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_AIProjectile_C__pf4023375717
{
	FRegisterHelper__ABP_AIProjectile_C__pf4023375717()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/BP/AI/Enemy/BP_AIProjectile"), &ABP_AIProjectile_C__pf4023375717::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_AIProjectile_C__pf4023375717 Instance;
};
FRegisterHelper__ABP_AIProjectile_C__pf4023375717 FRegisterHelper__ABP_AIProjectile_C__pf4023375717::Instance;
