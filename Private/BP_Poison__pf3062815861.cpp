...
#include "BP_Poison__pf3062815861.h"
...
ABP_Poison_C__pf3062815861::ABP_Poison_C__pf3062815861(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Poison_C__pf3062815861::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(-4.536167, -0.000046, 15.767353);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__4 = FVector(1.990731, 0.309412, 2.286232);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Box__pf), true, 0));
	bpv__UpDown__pf = false;
...
void ABP_Poison_C__pf3062815861::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Poison_C__pf3062815861::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__7.ComponentPropertyName = FName(TEXT("Box"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__BP_Poison_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Poison_C__pf3062815861::bpf__ExecuteUbergraph_BP_Poison__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(0.000000, 0.000000, 0.500000);
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpv__StaticMesh__pf->USceneComponent::K2_AddLocalOffset(bpfv__CallFunc_MakeVector_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_AddLocalOffset_SweepHitResult__pf, false);
				}
			}
		case 3:
			{
				FVector  __Local__8 = FVector(0.000000,0.000000,0.000000);
				UKismetMathLibrary::BreakVector(((::IsValid(bpv__StaticMesh__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__8)), /*out*/ b0l__CallFunc_BreakVector_X__pf, /*out*/ b0l__CallFunc_BreakVector_Y__pf, /*out*/ b0l__CallFunc_BreakVector_Z__pf);
				bpfv__CallFunc_GreaterEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_FloatFloat(b0l__CallFunc_BreakVector_Z__pf, 50.000000);
		...
		case 5:
			{
				bpfv__CallFunc_MakeVector_ReturnValue_1__pf = UKismetMathLibrary::MakeVector(0.000000, 0.000000, -0.500000);
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpv__StaticMesh__pf->USceneComponent::K2_AddLocalOffset(bpfv__CallFunc_MakeVector_ReturnValue_1__pf, false, /*out*/ b0l__CallFunc_K2_AddLocalOffset_SweepHitResult_1__pf, false);
				}
			}
		case 6:
			{
				FVector  __Local__9 = FVector(0.000000,0.000000,0.000000);
				UKismetMathLibrary::BreakVector(((::IsValid(bpv__StaticMesh__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__9)), /*out*/ b0l__CallFunc_BreakVector_X_1__pf, /*out*/ b0l__CallFunc_BreakVector_Y_1__pf, /*out*/ b0l__CallFunc_BreakVector_Z_1__pf);
				bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::LessEqual_FloatFloat(b0l__CallFunc_BreakVector_Z_1__pf, 0.000000);
		...
		case 13:
			{
				bpfv__CallFunc_MakeRotator_ReturnValue__pf = UKismetMathLibrary::MakeRotator(0.000000, 0.000000, 1.000000);
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpv__StaticMesh__pf->USceneComponent::K2_AddLocalRotation(bpfv__CallFunc_MakeRotator_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_AddLocalRotation_SweepHitResult__pf, false);
				}
				__CurrentState = 1;
				break;
			}
...
void ABP_Poison_C__pf3062815861::bpf__ExecuteUbergraph_BP_Poison__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(b0l__K2Node_ComponentBoundEvent_OtherActor__pf, b0l__K2Node_DynamicCast_AsThird_Person_Character__pf);
	...
	bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__Health__pf) : (__Local__10)), 20.000000);
	if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf))
	{
		b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__Health__pf = bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf;
	}
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void ABP_Poison_C__pf3062815861::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BP_Poison__pf_0(12);
}
void ABP_Poison_C__pf3062815861::bpf__BndEvt__BP_Poison_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_Poison__pf_1(8);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Poison_C__pf3062815861::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{456, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/Mei/Material/Pickups/Consume/Poison/CONSUME_Poison.CONSUME_Poison 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Poison_C__pf3062815861::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Poison_C__pf3062815861
{
	FRegisterHelper__ABP_Poison_C__pf3062815861()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/Material/Pickups/Consume/Poison/BP_Poison"), &ABP_Poison_C__pf3062815861::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Poison_C__pf3062815861 Instance;
};
FRegisterHelper__ABP_Poison_C__pf3062815861 FRegisterHelper__ABP_Poison_C__pf3062815861::Instance;
