...
#include "BP_Weapon__pf2275995960.h"
...
ABP_Weapon_C__pf2275995960::ABP_Weapon_C__pf2275995960(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Weapon_C__pf2275995960::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__3 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__StaticMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__4.AddUninitialized(2);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__4.GetData(), 2);
	...
	bpv__Capsule__pf->AttachToComponent(bpv__StaticMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__7 = (*(AccessPrivateProperty<float >((bpv__Capsule__pf), UCapsuleComponent::__PPO__CapsuleHalfHeight() )));
	__Local__7 = 78.000000f;
	auto& __Local__8 = (*(AccessPrivateProperty<float >((bpv__Capsule__pf), UCapsuleComponent::__PPO__CapsuleRadius() )));
	__Local__8 = 3.000000f;
	bpv__Capsule__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__9 = (*(AccessPrivateProperty<FVector >((bpv__Capsule__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__9 = FVector(0.000000, 0.000000, 40.000000);
	...
	auto& __Local__10 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__10 = FVector(0.000000, 0.000023, 40.742802);
	auto& __Local__11 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__11 = FVector(0.054143, 0.044009, 2.398517);
...
void ABP_Weapon_C__pf2275995960::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Weapon_C__pf2275995960::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__14.FunctionNameToBind = FName(TEXT("BndEvt__BP_Weapon_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Weapon_C__pf2275995960::bpf__ExecuteUbergraph_BP_Weapon__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 22);
	// optimized KCST_UnconditionalGoto
	bpv__AttackReady_0__pf = true;
	return; //KCST_EndOfThread
}
void ABP_Weapon_C__pf2275995960::bpf__ExecuteUbergraph_BP_Weapon__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABP_Weapon_C__pf2275995960::bpf__ExecuteUbergraph_BP_Weapon__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 9:
			{
				bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_ComponentBoundEvent_OtherActor__pf, 10.000000, ((AController*)nullptr), ((AActor*)nullptr), ((UClass*)nullptr));
			}
		case 10:
			{
				UKismetSystemLibrary::Delay(this, 0.400000, FLatentActionInfo(2, 442702649, TEXT("ExecuteUbergraph_BP_Weapon_2"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 11:
...
void ABP_Weapon_C__pf2275995960::bpf__ExecuteUbergraph_BP_Weapon__pf_3(int32 bpp__EntryPoint__pf)
{
		...
		case 14:
			{
				...
				AActor::K2_AttachToComponent(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? ((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsThird_Person_Character__pf), ACharacter::__PPO__Mesh() )))) : (__Local__16)), FName(TEXT("weapon_back")), EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::KeepRelative, true);
				__CurrentState = -1;
				break;
			}
		case 15:
			{
				...
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__EquippedWeapon__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__EquippedWeapon__pf->AActor::K2_DetachFromActor(EDetachmentRule::KeepRelative, EDetachmentRule::KeepRelative, EDetachmentRule::KeepRelative);
				}
			}
		case 16:
			{
		...
		case 17:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__EquippedWeapon__pf = this;
				}
				__CurrentState = 14;
				break;
			}
		case 18:
			{
				...
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__EquippedWeapon__pf) : (__Local__17)));
...
void ABP_Weapon_C__pf2275995960::bpf__AttackNoReady__pf()
{
	bpf__ExecuteUbergraph_BP_Weapon__pf_1(24);
}
void ABP_Weapon_C__pf2275995960::bpf__AttackReady__pf()
{
	bpf__ExecuteUbergraph_BP_Weapon__pf_0(22);
}
void ABP_Weapon_C__pf2275995960::bpf__BndEvt__BP_Weapon_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_Weapon__pf_2(20);
}
void ABP_Weapon_C__pf2275995960::bpf__PickUp__pf()
{
	bpf__ExecuteUbergraph_BP_Weapon__pf_3(19);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Weapon_C__pf2275995960::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Weapon_C__pf2275995960::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{279, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Mei/BP/Interfaces/Pickup/old/BPI_InteractWithWeapon.BPI_InteractWithWeapon_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Weapon_C__pf2275995960
{
	FRegisterHelper__ABP_Weapon_C__pf2275995960()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/BP/Pickup/old/BP_Weapon"), &ABP_Weapon_C__pf2275995960::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Weapon_C__pf2275995960 Instance;
};
FRegisterHelper__ABP_Weapon_C__pf2275995960 FRegisterHelper__ABP_Weapon_C__pf2275995960::Instance;
