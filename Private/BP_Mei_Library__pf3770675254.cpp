...
UBP_Mei_Library_C__pf3770675254::UBP_Mei_Library_C__pf3770675254(const FObjectInitializer& ObjectInitializer) : Super()
{
	
}
PRAGMA_ENABLE_OPTIMIZATION
void UBP_Mei_Library_C__pf3770675254::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UBP_Mei_Library_C__pf3770675254::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UBP_Mei_Library_C__pf3770675254::bpf__ActorIsLandscape__pf(AActor* bpp__Actor__pf, UObject* bpp____WorldContext__pf, /*out*/ bool& bpp__Result__pf)
{
	...
	bpfv__CallFunc_GetObjectClass_ReturnValue__pf = UGameplayStatics::GetObjectClass(bpp__Actor__pf);
	if(::IsValid(bpp__Actor__pf))
	{
		bpfv__CallFunc_ActorHasTag_ReturnValue__pf = bpp__Actor__pf->AActor::ActorHasTag(FName(TEXT("IsLandscape")));
	}
	bpfv__CallFunc_EqualEqual_ClassClass_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ClassClass(bpfv__CallFunc_GetObjectClass_ReturnValue__pf, ALandscape::StaticClass());
	bpfv__CallFunc_BooleanOR_ReturnValue__pf = UKismetMathLibrary::BooleanOR(bpfv__CallFunc_EqualEqual_ClassClass_ReturnValue__pf, bpfv__CallFunc_ActorHasTag_ReturnValue__pf);
	bpp__Result__pf = bpfv__CallFunc_BooleanOR_ReturnValue__pf;
}
void UBP_Mei_Library_C__pf3770675254::bpf__ActorsHaveLandscape__pf(/*out*/ TArray<AActor*>& bpp__Actors__pf, UObject* bpp____WorldContext__pf, /*out*/ bool& bpp__Result__pf)
{
	...
	do
	{
		...
		case 3:
			{
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpp__Actors__pf);
		...
		case 6:
			{
				FCustomThunkTemplates::Array_Get(bpp__Actors__pf, bpfv__Temp_int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				UBP_Mei_Library_C__pf3770675254::bpf__ActorIsLandscape__pf(bpfv__CallFunc_Array_Get_Item__pf, bpp____WorldContext__pf, /*out*/ bpfv__CallFunc_ActorIsLandscape_Result__pf);
		...
		case 7:
			{
				FCustomThunkTemplates::Array_Get(bpp__Actors__pf, bpfv__Temp_int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				UBP_Mei_Library_C__pf3770675254::bpf__ActorIsLandscape__pf(bpfv__CallFunc_Array_Get_Item__pf, bpp____WorldContext__pf, /*out*/ bpfv__CallFunc_ActorIsLandscape_Result__pf);
				bpp__Result__pf = bpfv__CallFunc_ActorIsLandscape_Result__pf;
				__CurrentState = -1;
				break;
			}
		case 8:
...
void UBP_Mei_Library_C__pf3770675254::bpf__IsValidHandle__pf(FDataTableRowHandle bpp__Handle__pf, UObject* bpp____WorldContext__pf, /*out*/ bool& bpp__IsValid__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(const_cast<UDataTable*>(bpp__Handle__pf.DataTable));
		...
		case 2:
			{
				bpfv__CallFunc_NotEqual_NameName_ReturnValue__pf = UKismetMathLibrary::NotEqual_NameName(bpp__Handle__pf.RowName, FName(TEXT("None")));
				bpp__IsValid__pf = bpfv__CallFunc_NotEqual_NameName_ReturnValue__pf;
				__CurrentState = -1;
				break;
			}
		case 3:
			{
				bpp__IsValid__pf = false;
				__CurrentState = -1;
				break;
			}
		default:
...
void UBP_Mei_Library_C__pf3770675254::bpf__GetGlobalBuildingRotationStep__pf(UObject* bpp____WorldContext__pf, /*out*/ float& bpp__StepValue__pf)
{
	float  __Local__0 = 0.000000;
	bpp__StepValue__pf = ((::IsValid(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())) ? (GetDefaultValueSafe<UBP_Mei_BuildingComponent_C__pf1731449071>(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())->bpv__BuildingRotationStepZ__pf) : (__Local__0));
}
void UBP_Mei_Library_C__pf3770675254::bpf__GetGlobalBuildingHeightStep__pf(UObject* bpp____WorldContext__pf, /*out*/ float& bpp__StepValue__pf)
{
	float  __Local__1 = 0.000000;
	bpp__StepValue__pf = ((::IsValid(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())) ? (GetDefaultValueSafe<UBP_Mei_BuildingComponent_C__pf1731449071>(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())->bpv__BuildingOffsetStepZ__pf) : (__Local__1));
}
void UBP_Mei_Library_C__pf3770675254::bpf__BuildingObjectIsFloorPlaceable__pf(ABP_Mei_Building_BaseObject_C__pf2826203124* bpp__BuildingObject__pf, UObject* bpp____WorldContext__pf, /*out*/ bool& bpp__Result__pf)
{
}
bool  UBP_Mei_Library_C__pf3770675254::bpf__NearlyEqualTransforms__pf(FTransform bpp__Transform1__pf, FTransform bpp__Transform2__pf, float bpp__LocationError__pf, float bpp__RotationError__pf, float bpp__ScaleError__pf, UObject* bpp____WorldContext__pf)
{
	...
	bool bpfv__CallFunc_EqualEqual_RotatorRotator_ReturnValue__pf{};
	bool bpfv__CallFunc_BooleanAND_ReturnValue__pf{};
	bool bpfv__CallFunc_BooleanAND_ReturnValue_1__pf{};
	UKismetMathLibrary::BreakTransform(bpp__Transform1__pf, /*out*/ bpfv__CallFunc_BreakTransform_Location__pf, /*out*/ bpfv__CallFunc_BreakTransform_Rotation__pf, /*out*/ bpfv__CallFunc_BreakTransform_Scale__pf);
	UKismetMathLibrary::BreakTransform(bpp__Transform2__pf, /*out*/ bpfv__CallFunc_BreakTransform_Location_1__pf, /*out*/ bpfv__CallFunc_BreakTransform_Rotation_1__pf, /*out*/ bpfv__CallFunc_BreakTransform_Scale_1__pf);
	bpfv__CallFunc_EqualEqual_VectorVector_ReturnValue__pf = UKismetMathLibrary::EqualEqual_VectorVector(bpfv__CallFunc_BreakTransform_Location__pf, bpfv__CallFunc_BreakTransform_Location_1__pf, bpp__LocationError__pf);
	bpfv__CallFunc_EqualEqual_VectorVector_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_VectorVector(bpfv__CallFunc_BreakTransform_Scale__pf, bpfv__CallFunc_BreakTransform_Scale_1__pf, bpp__ScaleError__pf);
	bpfv__CallFunc_EqualEqual_RotatorRotator_ReturnValue__pf = UKismetMathLibrary::EqualEqual_RotatorRotator(bpfv__CallFunc_BreakTransform_Rotation__pf, bpfv__CallFunc_BreakTransform_Rotation_1__pf, bpp__RotationError__pf);
	bpfv__CallFunc_BooleanAND_ReturnValue__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_EqualEqual_VectorVector_ReturnValue__pf, bpfv__CallFunc_EqualEqual_RotatorRotator_ReturnValue__pf);
	bpfv__CallFunc_BooleanAND_ReturnValue_1__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_BooleanAND_ReturnValue__pf, bpfv__CallFunc_EqualEqual_VectorVector_ReturnValue_1__pf);
	bpp__ReturnValue__pf = bpfv__CallFunc_BooleanAND_ReturnValue_1__pf;
	return bpp__ReturnValue__pf;
}
void UBP_Mei_Library_C__pf3770675254::bpf__GetGlobalGridSettings__pf(UObject* bpp____WorldContext__pf, /*out*/ float& bpp__GridFoundationOffset__pf, /*out*/ float& bpp__GridFoundationOffsetZ__pf, /*out*/ float& bpp__GridPropsOffset__pf, /*out*/ float& bpp__GridCorrectOffset__pf)
{
	float  __Local__2 = 0.000000;
	bpp__GridFoundationOffset__pf = ((::IsValid(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())) ? (GetDefaultValueSafe<UBP_Mei_BuildingComponent_C__pf1731449071>(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())->bpv__GridFoundationOffset__pf) : (__Local__2));
	float  __Local__3 = 0.000000;
	bpp__GridFoundationOffsetZ__pf = ((::IsValid(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())) ? (GetDefaultValueSafe<UBP_Mei_BuildingComponent_C__pf1731449071>(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())->bpv__GridFoundationOffsetZ__pf) : (__Local__3));
	float  __Local__4 = 0.000000;
	bpp__GridPropsOffset__pf = ((::IsValid(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())) ? (GetDefaultValueSafe<UBP_Mei_BuildingComponent_C__pf1731449071>(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())->bpv__GridPropsOffset__pf) : (__Local__4));
	float  __Local__5 = 0.000000;
	bpp__GridCorrectOffset__pf = ((::IsValid(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())) ? (GetDefaultValueSafe<UBP_Mei_BuildingComponent_C__pf1731449071>(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())->bpv__GridCorrectOffset__pf) : (__Local__5));
}
void UBP_Mei_Library_C__pf3770675254::bpf__GetPlayerID__pf(APlayerController* bpp__PlayerController__pf, UObject* bpp____WorldContext__pf, /*out*/ FString& bpp__PlayerID__pf)
{
	FString bpfv__CallFunc_GetPlayerName_ReturnValue__pf{};
	if(::IsValid(bpp__PlayerController__pf) && ::IsValid(bpp__PlayerController__pf->PlayerState))
	{
		bpfv__CallFunc_GetPlayerName_ReturnValue__pf = bpp__PlayerController__pf->PlayerState->APlayerState::GetPlayerName();
	}
	bpp__PlayerID__pf = bpfv__CallFunc_GetPlayerName_ReturnValue__pf;
}
void UBP_Mei_Library_C__pf3770675254::bpf__GetGlobalFloorNumberLimit__pf(UObject* bpp____WorldContext__pf, /*out*/ int32& bpp__FloorNumberLimit__pf)
{
	int32  __Local__6 = 0;
	bpp__FloorNumberLimit__pf = ((::IsValid(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())) ? (GetDefaultValueSafe<UBP_Mei_BuildingComponent_C__pf1731449071>(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())->bpv__FloorNumberLimit__pf) : (__Local__6));
}
void UBP_Mei_Library_C__pf3770675254::bpf__GetGlobalDestructChunksLifeTime__pf(UObject* bpp____WorldContext__pf, /*out*/ float& bpp__StepValue__pf)
{
	float  __Local__7 = 0.000000;
	bpp__StepValue__pf = ((::IsValid(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())) ? (GetDefaultValueSafe<UBP_Mei_BuildingComponent_C__pf1731449071>(UBP_Mei_BuildingComponent_C__pf1731449071::StaticClass())->bpv__DestructChunksLifeTime__pf) : (__Local__7));
}
PRAGMA_DISABLE_OPTIMIZATION
void UBP_Mei_Library_C__pf3770675254::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UBP_Mei_Library_C__pf3770675254::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UBP_Mei_Library_C__pf3770675254
{
	FRegisterHelper__UBP_Mei_Library_C__pf3770675254()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/BP/BuildingSystem/Game/BP_Mei_Library"), &UBP_Mei_Library_C__pf3770675254::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UBP_Mei_Library_C__pf3770675254 Instance;
};
FRegisterHelper__UBP_Mei_Library_C__pf3770675254 FRegisterHelper__UBP_Mei_Library_C__pf3770675254::Instance;
