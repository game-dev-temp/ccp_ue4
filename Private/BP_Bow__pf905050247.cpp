...
#include "AnimBP_Bow__pf905050247.h"
...
ABP_Bow_C__pf905050247::ABP_Bow_C__pf905050247(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	{
		__Local__2 = (USceneComponent::StaticClass())->FindPropertyByName(FName(TEXT("bVisible")));
		check(__Local__2);
		__Local__3 = __Local__2;
	}
	(((FBoolProperty*)__Local__2)->SetPropertyValue_InContainer((bpv__Arrow__pf), false, 0));
	...
	bpv__SkeletalMesh__pf->AnimClass = UAnimBP_Bow_C__pf905050247::StaticClass();
	bpv__SkeletalMesh__pf->ClothingSimulationFactory = UClothingSimulationFactoryNv::StaticClass();
	bpv__SkeletalMesh__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABP_Bow_C__pf905050247::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__SkeletalMesh__pf->VisibilityBasedAnimTickOption = EVisibilityBasedAnimTickOption::AlwaysTickPoseAndRefreshBones;
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__SkeletalMesh__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__4 = FVector(-15.834320, 0.000005, 0.000000);
	auto& __Local__5 = (*(AccessPrivateProperty<FRotator >((bpv__SkeletalMesh__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__5 = FRotator(180.000000, 90.000000, 0.000000);
	...
	auto& __Local__6 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__StaticMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__6 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Bow_C__pf905050247::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(0.914301, -0.000610, 0.000000);
	auto& __Local__8 = (*(AccessPrivateProperty<FRotator >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__8 = FRotator(0.000000, 90.000000, 0.000000);
...
void ABP_Bow_C__pf905050247::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Bow_C__pf905050247::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UAnimBP_Bow_C__pf905050247::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Bow_C__pf905050247::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Bow_C__pf905050247::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{334, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimBlueprintGeneratedClass /Game/Mei/BP/Pickup/self/Bow/AnimBP_Bow.AnimBP_Bow_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Bow_C__pf905050247
{
	FRegisterHelper__ABP_Bow_C__pf905050247()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Mei/BP/Pickup/self/Bow/BP_Bow"), &ABP_Bow_C__pf905050247::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Bow_C__pf905050247 Instance;
};
FRegisterHelper__ABP_Bow_C__pf905050247 FRegisterHelper__ABP_Bow_C__pf905050247::Instance;
